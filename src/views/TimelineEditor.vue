    ...
    <main class="timeline-main">
      <header class="timeline-header" @click="store.selectTrack(null)">
        ...
        <div class="header-controls">
          ...
          <el-dropdown @command="changeMode" trigger="click" placement="bottom-end">
            <button class="ea-btn ea-btn--sm ea-btn--lift ea-btn--hover-info" type="button" title="切换排轴器模式">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item command="endaxis" :disabled="route.path === '/timeline' || route.path.includes('endaxis')">终末地 (Endaxis)</el-dropdown-item>
                <el-dropdown-item command="zzz" :disabled="route.path.includes('zzz')">绝区零 (ZZZaxis)</el-dropdown-item>
              </el-dropdown-menu>
            </template>
          </el-dropdown>
