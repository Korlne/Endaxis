      ...
      <div class="section-container tech-style border-red">
        ...
        <div class="attribute-grid">
          ...
          <div class="form-group compact">
            ...
            <CustomNumberInput :model-value="targetData.cancel_windows?.dodge" @update:model-value="val => updateActionProp('cancel_windows', { ...targetData.cancel_windows, dodge: val })" :min="0" border-color="#ff7875" text-align="center"/>
          </div>
          <div class="form-group compact">
            <label>Skill 取消窗</label>
            <CustomNumberInput :model-value="targetData.cancel_windows?.skill" @update:model-value="val => updateActionProp('cancel_windows', { ...targetData.cancel_windows, skill: val })" :min="0" border-color="#ff7875" text-align="center"/>
          </div>
          <div class="form-group compact">
